...
emits app/denue.js — loaded lazily by the app and searched like every other
tier.

Input:  poi/denue_puebla.csv (from denue_21_csv.zip, INEGI; refreshed ~2x/yr)
Output: app/denue.js  const DENUE = {places: [{n, c: [lon,lat], k}]}
"""
import csv
import importlib
import json
