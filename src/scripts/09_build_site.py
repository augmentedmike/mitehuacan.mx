...
@media(min-width:701px){
 html{background:#18181b;display:flex;align-items:center;justify-content:center;min-height:100dvh}
 body{width:412px;max-width:412px;height:min(884px,96dvh);margin:0;
